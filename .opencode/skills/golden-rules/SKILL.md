---
name: golden-rules
description: Apply the project's strict coding, validation, typing, control-flow, testing, and verification standards. Use when modifying or reviewing any code in this repository.
---
